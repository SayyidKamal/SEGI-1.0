...
public class StudentMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    if (user.getImageURL().equals("default")){
                      ...
                      /*  try {
                            String profile_string = user.getImageURL();
                            URL profile_url = new URL(profile_string);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                StudentMainActivity.ViewPagerAdapter viewPagerAdapter = new StudentMainActivity.ViewPagerAdapter(getSupportFragmentManager());

                viewPagerAdapter.addFragment(new StudHomeFragment(),"Home");
